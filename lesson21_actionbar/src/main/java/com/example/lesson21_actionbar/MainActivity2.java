...
//        actionBar.setHomeAsUpIndicator();
    ...
    @OnCheckedChanged({R.id.as_up,R.id.display})
        @Override
...
//        share.setShareIntent(intent);
    ...
    private SearchView.OnQueryTextListener onQueryTextListener = new SearchView.OnQueryTextListener() {
        ...
        public boolean onQueryTextSubmit(String query) {
            Toast.makeText(MainActivity2.this, "onQueryTextSubmit===="+query+"====query", Toast.LENGTH_SHORT).show();
            return true;
        }

        @Override//文本改变时监听
        public boolean onQueryTextChange(String newText) {
            Toast.makeText(MainActivity2.this, "onQueryTextChange===="+newText+"====newText", Toast.LENGTH_SHORT).show();
            return true;
        }
    };
}